...
func NewHttpServer(svc Service, logger kitlog.Logger) *mux.Router {
	...
	decreaseProductQuantityHandler := kithttp.NewServer(
		makeDecreaseProductQuantityEndpoint(svc),
		decodeDecreaseProductQuantityRequest,
		encodeResponse,
		options...,
	)
...
func decodeDecreaseProductQuantityRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	var request decreaseProductQuantityRequest
